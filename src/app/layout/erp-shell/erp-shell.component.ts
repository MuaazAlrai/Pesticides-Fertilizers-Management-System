...
import { Bell, Boxes, Building2, ChevronDown, CircleDollarSign, LayoutDashboard, Menu, Package, ReceiptText, Search, Settings, ShoppingCart, Store, Truck, Users, WalletCards, X, LucideAngularModule } from 'lucide-angular';
...
export class ErpShellComponent {
  ...
  readonly icons = { Bell, Boxes, Building2, ChevronDown, CircleDollarSign, LayoutDashboard, Menu, Package, ReceiptText, Search, Settings, ShoppingCart, Store, Truck, Users, WalletCards, X };
  readonly links = [
    { label: 'Dashboard', path: '/dashboard', icon: LayoutDashboard },
    { label: 'Customers', path: '/customers', icon: Users },
    { label: 'Products', path: '/inventory', icon: Package },
    { label: 'Sales', path: '/sales', icon: CircleDollarSign },
    { label: 'POS', path: '/sales', icon: WalletCards },
